...
export default function CustomerDashboardLayout({
  ...
  const isProfileActive = pathname === '/dashboard/customer/profile';
    ...
    <RoleGuard allowedRoles={['CUSTOMER']}>
      <div className="flex-1 flex flex-col md:flex-row min-h-screen">
        ...
        <aside className="w-full md:w-64 border-r border-slate-200/50 bg-white dark:border-slate-800/50 dark:bg-slate-900 transition-colors duration-300 md:sticky md:top-0 md:h-screen flex flex-col justify-between shrink-0">
          ...
          {/* Top section: Logo, User widget & Nav */}
          ...
          {/* Bottom section: Logout & Book New Service */}
          <div className="p-4 border-t border-slate-100 dark:border-slate-850 space-y-3">
            ...
            <Link
              href="/services"
              className="flex items-center justify-center gap-1.5 w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-xs transition-all shadow-md active:scale-95"
            >
