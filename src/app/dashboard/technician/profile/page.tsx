...
export default function TechnicianProfilePage() {
  ...
  // Local state for profile and skills matching Figma screenshot
  const [profile, setProfile] = useState({
    name: 'Mike Johnson',
    memberSince: 'Oct 2023',
    bio: 'Expert technician with over 5 years of experience in general maintenance, plumbing, and electrical repairs. Committed to high-quality service.',
    hourlyRate: '500',
    isAvailable: true,
    isVerified: true
  });

  const [skills, setSkills] = useState(['Plumbing', 'Electrical', 'AC Repair']);
  ...
  const handleToggleAvailability = () => {
    setProfile(prev => {
      const updated = !prev.isAvailable;
      toast.success(updated ? 'Availability turned ON' : 'Availability turned OFF');
      return { ...prev, isAvailable: updated };
    });
  };
  ...
  const handleUpdateRate = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!profile.hourlyRate || isNaN(Number(profile.hourlyRate)) || Number(profile.hourlyRate) <= 0) {
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/60 rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
            ...
            <button
              ...
              className="px-4 py-2 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-850 text-slate-655 dark:text-slate-300 font-bold rounded-xl text-xs transition-colors shrink-0 active:scale-95"
            >
              Edit Photo
            </button>
          </div>
            ...
            <form onSubmit={handleSaveBio} className="space-y-4">
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white font-bold rounded-xl text-xs transition-all shadow-sm active:scale-95 flex items-center justify-center min-w-[90px]"
                >
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/60 rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
            ...
            <div className="space-y-5">
                ...
                {skills.map((skill) => (
                  ...
                  >
                    ...
                    <button 
                      ...
                      className="p-0.5 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded-full text-blue-500 hover:text-blue-700 transition-colors"
                    >
              ...
              <form onSubmit={handleAddSkill} className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="p-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl shadow-sm transition-all active:scale-95 flex items-center justify-center shrink-0"
                >
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/60 rounded-3xl p-6 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
            ...
            <form onSubmit={handleUpdateRate} className="space-y-4.5">
              ...
              <button
                ...
                className="w-full py-3 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white font-bold rounded-xl text-xs transition-all shadow-sm active:scale-95 flex items-center justify-center"
              >
